                            ...
                            child: GestureDetector(
                              onTap: (){
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => DetailNotificationsPage(list: list, index: index),
                                  ),
                                );
                              },
                              child: Row(
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          list[index]['Time'],
                                          style: const TextStyle(fontWeight: FontWeight.w200, color: Color.fromARGB(255, 66, 72, 82),fontSize: 13),
                                        )
                                      ],
                                    ),
                                  ),
...
class DetailNotificationsPage extends StatelessWidget {
  ...
  const DetailNotificationsPage({Key? key, required this.list, required this.index}) : super(key: key);
        ...
        child: Center(
          child: Column(
            children: <Widget>[
              ...
              const SizedBox(height: 16.0),
              Text(list[index]['Time'], style: const TextStyle(fontWeight: FontWeight.w300),),
              const SizedBox(height: 16.0),
            ],
